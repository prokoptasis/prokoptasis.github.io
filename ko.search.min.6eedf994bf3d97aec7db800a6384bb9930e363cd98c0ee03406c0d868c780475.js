...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.f898584094154988e0881ceffeeb4e86d985c74bfd76f0ab37b66180e0a33ea6.js',function(){input.required=false;search();});}
