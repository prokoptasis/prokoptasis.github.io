...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.fd7ad174130e930352e1fb7b40152cd062d25cb66cd215a1bcb0c3b221022368.js',function(){input.required=false;search();});}
