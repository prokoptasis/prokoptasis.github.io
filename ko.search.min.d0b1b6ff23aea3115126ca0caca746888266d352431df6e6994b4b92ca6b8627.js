...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.a136052bef42f9d9b53e8a0ccb3295749c2077e42f6b8018676798d6ec781c5d.js',function(){input.required=false;search();});}
