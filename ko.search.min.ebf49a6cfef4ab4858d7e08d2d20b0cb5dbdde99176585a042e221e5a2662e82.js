...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.9636cd006e7de80bc098707b4205a1feeddc545c35c339c27dadca0258f51f57.js',function(){input.required=false;search();});}
