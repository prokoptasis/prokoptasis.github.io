...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ae30da8d4ef5aa2be6271fee3b21130f111f9d8e217584f5912c61d0ae59c526.js',function(){input.required=false;search();});}
