...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.3fe1bab70f8a9cd11214d8a51fb312695f78eeb2f41ca08b8280efc424b6a266.js',function(){input.required=false;search();});}
