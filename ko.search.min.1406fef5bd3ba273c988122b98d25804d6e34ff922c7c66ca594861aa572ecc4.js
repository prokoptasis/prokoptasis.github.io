...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.fb37455143a139a195abd1001f125cd469c34764c500e7e406e514ee5ad63a31.js',function(){input.required=false;search();});}
