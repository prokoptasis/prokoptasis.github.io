...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.9587abae6f82011a86a2be673dfa952bd8f536ce307196258390af63c5571731.js',function(){input.required=false;search();});}
