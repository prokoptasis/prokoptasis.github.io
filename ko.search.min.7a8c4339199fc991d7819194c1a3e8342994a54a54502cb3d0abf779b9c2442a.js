...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.5af39f60fd41f068aa442c47fdeed94057cf651748be0028bc65001627217a2f.js',function(){input.required=false;search();});}
