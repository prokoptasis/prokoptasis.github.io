...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.fdd5e6183c3bf31cd784d2d05f7c44d034a6d3efcfd6b65f6c3cc92bd600cdbf.js',function(){input.required=false;search();});}
