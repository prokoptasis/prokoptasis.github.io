...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.f6e0ef28e413cb056b0a13581a582eccd97d9be005f270785ca4f943cce13b83.js',function(){input.required=false;search();});}
