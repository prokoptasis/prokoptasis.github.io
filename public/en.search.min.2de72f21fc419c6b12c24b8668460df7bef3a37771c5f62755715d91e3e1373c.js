...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.209974d5f633c45be1be74b467355888b0ac054add36ed085e3a2a78f9401eb5.js',function(){input.required=false;search();});}
